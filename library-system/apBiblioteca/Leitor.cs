    ...
    class Leitor : IComparable<Leitor>, IRegistro
    {
        ...
        public void LerRegistro(StreamReader arq)
        {
            if (!arq.EndOfStream)
            {
                ...
                QuantosLivrosComLeitor = int.Parse(linha.Substring(inicioQuantosLivros, tamanhoQuantosLivros));
        ...
        public String ParaArquivo()
        {
            string saida = CodigoLeitor.ToString() + NomeLeitor +
                           EnderecoLeitor +
                           QuantosLivrosComLeitor.ToString().PadLeft(tamanhoQuantosLivros, '0');
        ...
        {
            return CodigoLeitor + " " + NomeLeitor + " " + EnderecoLeitor;
        }
        ...
        {
            dgv.Rows.Add(codigoLeitor, nomeLeitor, EnderecoLeitor, QuantosLivrosComLeitor, codigoLivroComLeitor);
        }
    }
}
